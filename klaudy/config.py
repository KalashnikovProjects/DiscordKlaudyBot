...
class BotConfig:
    ...
    message_history = 15  # Сколько сообщений загружается в контекст боту
    ...
    Когда хочешь ты можешь писать длинные сообщения. 
    ...
    Упоминай участников только в том случае, если нужно позвать их (обратиться к ним), иначе просто пиши их ник без @. 
