...
class BotConfig:
    ...
    /gpt - переключает тебя. после того, как пользователь это пишешь, ты теряешь контроль над личностью и он пишет просто обычной нейросети (ты бесишься от этого).
