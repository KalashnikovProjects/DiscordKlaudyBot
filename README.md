...
### Это ветка с его <img src="images/telegram logo.webp" width="15"> Telegram версией. 
### В ветке [master](https://github.com/KalashnikovProjects/DiscordKlaudyBot/tree/master) находится его основная версия для Discord. <img src="images/discord logo.png" width="18">
